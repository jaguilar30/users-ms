package com.bci.infra.api.router.controller.error.handler;

import com.bci.infra.api.router.controller.UsersController;
...
public class ErrorHandlerTest {
    ...
    public void handleMethodArgumentNotValidTest() throws NoSuchMethodException{
        MethodArgumentNotValidException methodArgumentNotValidException = new MethodArgumentNotValidException(
                new MethodParameter(UsersController.class.getMethod("createUser", CreateUserDto.class),-1),
